...
//slick
$('#work_quote_slider').slick({
	appendArrows: '#work_slider_controls',
	prevArrow: '#work_prev_arrow',
	nextArrow: '#work_next_arrow'
});
$('#service_auote_slider').slick({
	appendArrows: '#service_slider_controls',
...
$(".header_slider").slick({
 ...
 //ticking machine
    ...
    $('.pagging .progressBar').each(function(index) {
    ...
    function interval() {
        if (($('.header_slider .slick-track div[data-slick-index="' + progressBarIndex + '"]').attr("aria-hidden")) === "true") {
            progressBarIndex = $('.header_slider .slick-track div[aria-hidden="false"]').data("slickIndex");
            startProgressbar();
        } else {
